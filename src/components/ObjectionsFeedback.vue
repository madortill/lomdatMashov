...
export default {
    ...
    data() {
        return {
            ...
            arrayInfo: ['התנגדויות במשוב ב-ביטוי התנהגותי של הנחנך לאי רצונו או יכולתו להמשיך בתקשורת עם החונך.', 'תהליך הטיפול בהתנגדות', 'לפניכם קטע תירגול סימולצית סירטונים. תצטרכו לצפות בסירטון ולתאם את ההתנגדות שמופיע בסירטון.'],
            arrayProcess: [
                'זיהוי התנגדות',
                'עצירה ושיקוף',
                'איתור סיבת ההתנגדות',
