<template>
    <div id="quick-questions">
        ...
        <div class="answers-container" @click="checkAnswer">
            <div class="row">
                <button id="1" class="pulse-button-hover">{{ questions1[indexQ].ans1 }}</button>
                <button id="2" class="pulse-button-hover">{{ questions1[indexQ].ans2 }}</button>
            </div>
            <div class="row">
                <button id="3" class="pulse-button-hover">{{ questions1[indexQ].ans3 }}</button>
                <button id="4" class="pulse-button-hover">{{ questions1[indexQ].ans4 }}</button>
            </div>
        </div>
    </div>
</template>
